...
export default function WorkspaceView() {
	...
	const user = JSON.parse(localStorage.getItem("noto-auth-user") ?? "{}");
			...
			<section className="mx-auto w-full max-w-6xl px-6 py-10">
				<div className="rounded-3xl border border-sky-100 bg-white p-6 shadow-sm md:p-8">
					...
					<p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
						Tulis apa aja di sini. Mau nyatet ide, bikin checklist,
						nyimpen potongan kode, atau sekadar dump isi kepala juga
						bisa.
					</p>
				</div>
